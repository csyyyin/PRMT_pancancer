...
{
  my_data = read.csv('D:/PRMT/julei/PRMT.csv',header=T,check.names=F)
  ...
  final_matrix = read.csv(paste0('D:/PRMT/julei/',sample_name,'.k=',which(temp_var_k==max(temp_var_k))+1,'.consensusMatrix.csv'),row.names = 1)
  ...
  pdf(paste0(,'D:/PRMT/julei/cluster.pdf'))
