...
setwd(dir = "D:/PRMT/yizhix")
temp = list.files(pattern="*.csv")


df = read.csv('D:/PRMT/yizhix/p.csv',header=T,row.names=1)
...
# #yzx
 myColor <- colorRampPalette(c( "#0032ff", "white","#831A21"))(paletteLength)
# #gx
#myColor <- colorRampPalette(c( "#6a3906", "white","#c9a063"))(paletteLength)
# #normal tumor
# myColor <- colorRampPalette(c( "#B8DCA1", "white","#D5E490"))(paletteLength)
# CIBER
# myColor <- colorRampPalette(c( '#86C06C', "white",'#8197C6'))(paletteLength)
# fenqi
#myColor <- colorRampPalette(c( '#507AAF', "white",'#5B9C4B'))(paletteLength)
