...
setwd(dir = "D:/PRMT/ganxing")
temp = list.files(pattern="*.csv")


df = read.csv('D:/PRMT/ganxing/p.csv',header=T,row.names=1)
...
# #gx
myColor <- colorRampPalette(c( "#2e3192", "white","#A13D3B"))(paletteLength)
# #normal tumor
#myColor <- colorRampPalette(c( "#42210b", "white","#9999ff"))(paletteLength)
# CIBER
# myColor <- colorRampPalette(c( '#86C06C', "white",'#8197C6'))(paletteLength)
# fenqi
#myColor <- colorRampPalette(c( "white",'#507AAF', '#5B9C4B'))(paletteLength)
